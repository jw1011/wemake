      ...
      <div className="space-y-10">
        <div className="space-y-1">
          ...
          <p className="text-muted-foreground">
            ...
            sed, illum maiores asperiores ipsa non quod consequatur quaerat
            assumenda suscipit, placeat atque hic iste eligendi. Vitae enim
            possimus eveniet eius!
          </p>
        </div>
        <div className="space-y-1">
          ...
          <p className="text-muted-foreground">
            ...
            architecto, dicta totam beatae recusandae provident quod labore.
            Dolore consequatur enim, repellat quia maiores incidunt illo
            laborum, cupiditate, quaerat voluptatibus eum?
          </p>
        </div>
      </div>
    </div>
